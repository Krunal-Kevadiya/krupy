...
!!! warning
    ...
    Krupy 5 and older had different, bracket-based defaults.

    If your template was created for Krupy 5, you need to add this configuration to
    ...
    By specifying this, your template will be compatible with both Krupy 5 and 6.

    Krupy 6 will apply these older defaults if your [min_krupy_version][] is lower
    than 6.

    Krupy 7+ no longer uses the old defaults independent of [min_krupy_version][].
...
!!! warning
    ...
    Krupy 5 and older had a different default value: `.tmpl`. If you wish to keep it,
    add it to your `krupy.yml` to keep it future-proof.

    Krupy 6 will apply that old default if your [min_krupy_version][] is lower
    than 6.

    Krupy 7+ no longer uses the old default independent of [min_krupy_version][].
...
!!! warning
    ...
    This behavior is new from Krupy 5.0.0. Before that release, prereleases were
    never ignored.

...
from .helpers import KRUPY_PATH, Spawn, build_file_tree, expect_prompt
...
def test_render_conditional(tmp_path_factory: TempPathFactory) -> None:
    ...
    krupy.run_copy(str(src), dst, data={"conditional": {"variable": True}})
...
def test_answer_changes(
    ...
    if interactive:
        ...
        krupy.run_copy(str(src), dst, data={"condition": True})
    ...
    if interactive:
        ...
        krupy.run_update(dst_path=dst, data={"condition": False}, overwrite=True)
